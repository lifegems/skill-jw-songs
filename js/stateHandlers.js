...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            var message = 'Welcome to J W Original Songs. You can say, play the audio to begin the songs.';
    ...
    playModeIntentHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            if (this.attributes['playbackFinished']) {
                this.handler.state = constants.states.START_MODE;
                message = 'Welcome to J W Original Songs. You can say, play the audio to begin the songs.';
        ...
        'AMAZON.HelpIntent' : function () {
            ...
            var message = 'You are listening to J W Original Songs. You can say, Next or Previous to navigate through the songs. ' +
